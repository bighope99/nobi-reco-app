-- Create RPC function to atomically update observation tags
-- This function ensures data integrity by performing delete and insert operations
-- within a single transaction with automatic rollback on error
...
GRANT EXECUTE ON FUNCTION update_observation_tags TO authenticated;
