---
name: create-pr
description: PRをプッシュしてCodeRabbitのレビューを待機し、指摘事項を修正するワークフロー。実装完了後に使用する。
...
修正をプッシュしたらStep 2に戻る（最大3ラウンド）。

| 条件 | 次のアクション |
|-----|-------------|
| 未対応のCriticalコメントが残っている | → Step 2 に戻る |
